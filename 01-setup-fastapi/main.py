...
# --- Static login routes (More Specific) ---
...
# --- Dynamic login routes (Less Specific) ---
...
# --- Static Profile Update Routes (More Specific) ---
...
# --- Dynamic Profile Update Routes (Less Specific) ---
...
def post_discussion(username: str, post: Post, post_type: PostType):
    if valid_users.get(username) == None:
        return {"message": "user does not exist"}
    # The check below seems logically incorrect if 'id' is a new UUID
